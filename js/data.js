    ...
    levels: [
      {
        ...
        name: 'レベル1 中学基礎',
        items: [
          { id: 'en1-01', front: 'ability', back: '能力', explanation: 'able（〜できる）の名詞形。「〜する能力」は ability to do の形で使います。' },
          { id: 'en1-02', front: 'borrow', back: '借りる', explanation: '無料で借りるときは borrow、貸す側は lend。お金を払って借りる場合は rent。' },
          { id: 'en1-03', front: 'careful', back: '注意深い', explanation: 'care（注意）+ ful（満ちた）。Be careful! で「気をつけて!」。' },
          { id: 'en1-04', front: 'decide', back: '決める', explanation: 'decide to do で「〜することに決める」。名詞形は decision。' },
          { id: 'en1-05', front: 'enough', back: '十分な', explanation: '発音は「イナフ」。形容詞の後ろに置く点に注意（old enough）。' },
          { id: 'en1-06', front: 'forget', back: '忘れる', explanation: '過去形は forgot、過去分詞は forgotten。反対語は remember。' },
          { id: 'en1-07', front: 'gather', back: '集める', explanation: '人や物が「集まる」という自動詞としても使えます。' },
          { id: 'en1-08', front: 'health', back: '健康', explanation: '形容詞は healthy。ea は短く「ヘルス」と読みます。' },
          { id: 'en1-09', front: 'improve', back: '改善する', explanation: '成績や技術が「上達する」という意味でも使います。名詞形は improvement。' },
          { id: 'en1-10', front: 'journey', back: '旅', explanation: '主に陸路の長い旅。trip は短い旅行、travel は移動そのものを指します。' },
          { id: 'en1-11', front: 'kindness', back: '親切', explanation: 'kind（親切な）+ ness（性質）。ness は抽象名詞をつくる頻出の接尾辞です。' },
          { id: 'en1-12', front: 'lend', back: '貸す', explanation: 'lend A B で「AにBを貸す」。借りる側は borrow。' },
          { id: 'en1-13', front: 'mistake', back: '間違い', explanation: 'make a mistake で「間違える」。by mistake は「うっかり」。' },
          { id: 'en1-14', front: 'notice', back: '気づく', explanation: '名詞では「掲示・通知」。notice that 〜 で「〜だと気づく」。' },
          { id: 'en1-15', front: 'opinion', back: '意見', explanation: 'In my opinion, 〜 で「私の意見では」。英作文でよく使います。' },
          { id: 'en1-16', front: 'perhaps', back: 'たぶん', explanation: 'maybe とほぼ同じ意味ですが、perhaps の方がやや硬い表現です。' },
          { id: 'en1-17', front: 'quiet', back: '静かな', explanation: 'quite（かなり）とつづりが似ているので要注意。' },
          { id: 'en1-18', front: 'reason', back: '理由', explanation: 'the reason why 〜 で「〜する理由」。動詞では「推論する」。' },
          { id: 'en1-19', front: 'suddenly', back: '突然', explanation: 'sudden（突然の）+ ly。all of a sudden も同じ意味です。' },
          { id: 'en1-20', front: 'through', back: '〜を通って', explanation: '発音は「スルー」。though（けれども）と混同しやすい語です。' },
        ],
      },
      {
        id: 'en-2',
        name: 'レベル2 高校標準',
        items: [
          { id: 'en2-01', front: 'abandon', back: '見捨てる', explanation: '「放棄する」の意味でも頻出。abandon the plan で「計画を断念する」。' },
          { id: 'en2-02', front: 'benefit', back: '利益', explanation: '動詞では「利益を得る」。benefit from 〜 の形が頻出です。' },
          { id: 'en2-03', front: 'consider', back: '熟考する', explanation: 'consider doing で「〜しようかと考える」。to不定詞は取りません。' },
          { id: 'en2-04', front: 'demand', back: '要求する', explanation: '経済用語では「需要」。supply and demand で「需要と供給」。' },
          { id: 'en2-05', front: 'establish', back: '設立する', explanation: '会社や制度を「確立する」。名詞形は establishment。' },
          { id: 'en2-06', front: 'frequent', back: '頻繁な', explanation: '副詞 frequently（しばしば）の形でよく出ます。' },
          { id: 'en2-07', front: 'generate', back: '生み出す', explanation: '電力や利益を「発生させる」。名詞形は generation。' },
          { id: 'en2-08', front: 'hesitate', back: 'ためらう', explanation: 'hesitate to do で「〜するのをためらう」。' },
          { id: 'en2-09', front: 'indicate', back: '示す', explanation: 'データやグラフが「示している」と述べるときの定番語です。' },
          { id: 'en2-10', front: 'maintain', back: '維持する', explanation: '「主張する」の意味もあります。名詞形は maintenance。' },
          { id: 'en2-11', front: 'negotiate', back: '交渉する', explanation: '名詞形は negotiation。ビジネス英語の頻出語です。' },
          { id: 'en2-12', front: 'obvious', back: '明らかな', explanation: 'It is obvious that 〜 で「〜は明らかだ」。副詞は obviously。' },
          { id: 'en2-13', front: 'presume', back: '推定する', explanation: 'assume（仮定する）より根拠のある推定を表します。' },
          { id: 'en2-14', front: 'reduce', back: '減らす', explanation: 're（後ろへ）+ duce（導く）。reduce A to B で「AをBまで減らす」。' },
          { id: 'en2-15', front: 'significant', back: '重要な', explanation: '「かなりの」という量的な意味もあります。名詞は significance。' },
          { id: 'en2-16', front: 'sufficient', back: '十分な', explanation: 'enough の硬い言い方。反対語は insufficient。' },
          { id: 'en2-17', front: 'tendency', back: '傾向', explanation: 'have a tendency to do で「〜する傾向がある」。動詞は tend。' },
          { id: 'en2-18', front: 'ultimate', back: '究極の', explanation: '副詞 ultimately は「最終的に」。結論を述べるときに使います。' },
          { id: 'en2-19', front: 'various', back: 'さまざまな', explanation: '名詞形は variety。a variety of 〜 で「さまざまな〜」。' },
          { id: 'en2-20', front: 'withdraw', back: '撤回する', explanation: '「お金を引き出す」意味でも使います。過去形は withdrew。' },
        ],
      },
    ],
  },
